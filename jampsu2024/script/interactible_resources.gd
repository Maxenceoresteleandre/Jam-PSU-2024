...
const COLLECTIBLE_RESOURCE_PATH := preload("res://scenes/environment/interactible_objects/Collectible.tscn")
const CRATE_SPRITES := [
...
func _ready() -> void:
	var resource_sprite : Collectible = COLLECTIBLE_RESOURCE_PATH.instantiate()
